...
from octolyzer.measure.slo.retina import Retina, Window, detect_vessel_border
from octolyzer.measure.slo.tortuosity_measures import (global_cal, distance_measure_tortuosity, 
...
def measure_sloroi(binmap, fovea, od_centre, od_radius,
    ...
    # if distance != 0 and not whole_image:
    ...
    roi_Window = Window(roi_Retina, WINDOW_SHAPE, min_pixels=MIN_WINDOW_PIXEL)
